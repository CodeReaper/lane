...
func TestEscapingSingleColumn(t *testing.T) {
	output := "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n<resources>\n    <string name=\"that\" formatted=\"false\">Another string including a | even.</string>\n    <string name=\"this\" formatted=\"false\">This is a longer sentence, which includes a comma.</string>\n</resources>\n"
